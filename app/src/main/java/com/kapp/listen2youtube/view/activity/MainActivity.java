...
import com.kapp.listen2youtube.presenter.FetchLocalFileList;
import com.kapp.listen2youtube.presenter.FetchPlayList;
import com.kapp.listen2youtube.presenter.FetchRelatedVideo;
import com.kapp.listen2youtube.presenter.GetLink;
import com.kapp.listen2youtube.presenter.IPresenterCallback;
import com.kapp.listen2youtube.presenter.YoutubeQuery;
import com.kapp.listen2youtube.service.DownloadService;
import com.kapp.listen2youtube.service.PlaybackService;
import com.kapp.listen2youtube.view.adapter.LocalFileAdapter;
import com.kapp.listen2youtube.view.adapter.PlayListAdapter;
import com.kapp.listen2youtube.view.adapter.SearchOnlineAdapter;
import com.kapp.listen2youtube.view.fragment.RecyclerViewFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    private void onCardViewClick(View view, int position, int fragmentId) {
        Log.e(TAG, "onCardViewClick - line 288: " + fragmentId + " pos " + position);
        switch (fragmentId) {
    ...
    public void onFinish(int jobType, Object result) {
        switch (jobType) {
            ...
            case JOB_TYPE_FETCH_PLAY_LIST:
                if (result != null) {
                    Log.e(TAG, "onFinish - line 359: JOB_TYPE_FETCH_PLAY_LIST");
